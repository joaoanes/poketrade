      ...
      {({ height, width }) => {
        ...
        return (
          <FixedSizeGrid
            ...
            itemData={{ pokemons, columnCount, setSelected }} // Pass data to optimize rendering
            itemKey={({ columnIndex, rowIndex, data }) =>
              rowIndex * data.columnCount + columnIndex
                ...
                <div style={style}>
                  {pokemon && (
                    <div onClick={() => setSelected(pokemon)}>
                      <PokemonSquare pokemon={pokemon} quick={pokemons.length < 20} />
                    </div>
                  )}
                </div>
              );
